...
# NOTE: All Chrome/Edge UAs use the latest stable release (Chrome 132 / Edge 132).
...
USER_AGENTS = [
    # Windows — Chrome 132 (latest stable as of early 2025)
    ...
    # Windows — Edge 132 (Chromium-based; UA must match Chrome version)
